...
class SWARadixCache(KVCacheEventMixin, BasePrefixCache):
    ...
    def cache_unfinished_req(self, req: Req, chunked=False) -> None:
        ...
        # prompt into committed output tokens that were cached before the retract.
        # Clamping to the prompt alone would re-cache fewer tokens than are protected,
        # dropping cache_protected_len and leaking the extra slot's lock.
