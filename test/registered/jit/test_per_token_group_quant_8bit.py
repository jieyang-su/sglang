...
def test_per_token_group_quant_with_column_major(
    ...
    # Use the platform-native fp8 type (e4m3fnuz on ROCm, e4m3fn on CUDA),
    # matching the input dtype set above; a hardcoded e4m3fn buffer is wrong
    # on ROCm and makes the comparison fail.
    fp8_dtype = fp8_type_
